...
### Looking for previous versions?
    ...
    https://github.com/denniselite/iris-fixed#version
...
**How to upgrade**: Open your command-line and execute this command: `go get -u github.com/denniselite/iris-fixed`.
...
> This was one of the most popular community's feature requests. Click [here](https://github.com/denniselite/iris-fixed/blob/master/_examples/beginner/routing/overview/main.go) to see a trivial example.

# Sa, 10 June 2017 | v7.0.4

- Simplify and add a test for the [basicauth middleware](https://github.com/denniselite/iris-fixed/tree/master/middleware/basicauth), no need to be
...
After 2+ months of hard work and collaborations, Iris [version 7](https://github.com/denniselite/iris-fixed) was published earlier today.

If you're new to Iris you don't have to read all these, just navigate to the [updated examples](https://github.com/denniselite/iris-fixed/tree/master/_examples) and you should be fine:)
...
## Changes from [v6](https://github.com/denniselite/iris-fixed/tree/v6)
...
- All `Listen` methods replaced with a single `Run` method, see [here](https://github.com/denniselite/iris-fixed/tree/master/_examples/beginner/listening)
- Configuration, easier to modify the defaults, see [here](https://github.com/denniselite/iris-fixed/tree/master/_examples/beginner/cofiguration)
- `HandlerFunc` removed, just `Handler` of `func(context.Context)` where context.Context derives from `import "github.com/denniselite/iris-fixed/context"` (on August this import path will be optional)
...
- Remove of multiple routers, now we have the fresh Iris router which is based on top of the julien's [httprouter](https://github.com/julienschmidt/httprouter).
    > Update 11 June 2017: As of 7.0.5 this is changed, read [here](https://github.com/denniselite/iris-fixed/blob/master/HISTORY.md#su-11-june-2017--v705).
...
Click [here](https://github.com/denniselite/iris-fixed/tree/master/_examples/beginner/routing) for details.
...
- Easy way to change Iris' default `Context` with a custom one, see [here](https://github.com/denniselite/iris-fixed/tree/master/_examples/intermediate/custom-context)
...
- Able to set custom underline *http.Server(s) with new Host (aka Server Supervisor) feature 
    ...
    - Schedule custom tasks(with cancelation) when server is running, see [here](https://github.com/denniselite/iris-fixed/tree/master/_examples/intermediate/graceful-shutdown)
