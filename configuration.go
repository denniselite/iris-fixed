...
type Configuration struct {
	...
	// Change to false it if you want something like this https://github.com/denniselite/iris-fixed/issues/135 to work
	//
	...
	// currently we have only one: https://github.com/denniselite/iris-fixed/tree/master/middleware/i18n.
	//
