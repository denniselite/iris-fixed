...
This folder provides easy to understand code snippets on how to get started with web development with the Go programming language using the [Iris](https://github.com/denniselite/iris-fixed) web framework.
...
> Do not forget to [star or watch the project](https://github.com/denniselite/iris-fixed/stargazers) in order to stay updated with the latest tech trends, it takes some seconds for the sake of go!

> Developers should read the official [documentation](https://godoc.org/github.com/denniselite/iris-fixed) in depth, for deep understanding.
